          ...
          <div className="rounded-xl border border-white p-10">
            ...
            <div className="experience mt-10">
              <div className="relative">
                <h2 className="relative z-[1] text-3xl font-bold">
                  Lorem Ipsum
                </h2>
                <div className="w-auto">
                  <svg
                    aria-hidden="true"
                    viewBox="0 0 281 40"
                    class="absolute top-1/2 left-0 w-[12rem] fill-orange"
              ...
              <div className="mt-10 grid grid-cols-2">
                <div className="min-h-[200px] border border-white p-6">
                  <p>
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                    Placeat eos veritatis quisquam atque, ducimus nihil quasi
                    corrupti! Suscipit, placeat! Sapiente doloribus, maxime quod
                    rem iusto atque laboriosam placeat voluptate mollitia.
                  </p>
                </div>
                <div className="min-h-[200px] border border-white p-6">
                  <p>
