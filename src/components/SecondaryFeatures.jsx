...
function FeaturesDesktop() {
  let tableAnim = useRef(null)
  let toptobottom = useRef(null)
  useEffect(() => {
    gsap.fromTo(
      tableAnim.current,
      {
...
export function SecondaryFeatures() {
  ...
  let allItem2 = useRef(null)
  let allItem3 = useRef(null)
